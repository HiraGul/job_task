          ...
          children: [
            ...
            Expanded(
              child: Align(
                ...
                child: BlocBuilder<UploadProfileDocumentCubitCubit,
                    UploadProfileDocumentCubitState>(
                  builder: (context, state) {
                    print("State is $state");
                    if (state is UploadProfileImageLoadedState) {
                      return GestureDetector(
                        onTap: () async {
                    ...
                    } else if (state is UploadProfileDocumentLoadedState) {
                      return Container(
                        height: 45.h,
                        width: 60.w,
                        decoration: BoxDecoration(
