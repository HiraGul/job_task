          ...
          children: [
            ...
            Expanded(
              child: Align(
                ...
                child: BlocBuilder<UploadCertificateDocumentCubitCubit,
                    UploadCertificateDocumentCubitState>(
                  builder: (context, state) {
                    print("State is $state");
                    if (state is UploadedCertificateImage) {
                      return GestureDetector(
                        onTap: () async {
                    ...
                    } else if (state is UploadedCertificateDocument) {
                      return Container(
                        height: 45.h,
                        width: 60.w,
                        decoration: BoxDecoration(
